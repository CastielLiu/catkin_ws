...
void GetContoursPic(const char* pSrcFileName, const char* pDstFileName)
{
    ...
    for (int i = 0; i < contours.size(); i++)
    {
        ...
        imshow("RatationedImg", RatationedImg);
...
int main()
{
	std::string srcImage = "/home/wendao/projects/catkin_ws/src/opencv/image/rmb.png";
	std::string dstImage = "/home/wendao/projects/catkin_ws/src/opencv/image/dstRmb.png";
    GetContoursPic(srcImage.c_str(), dstImage.c_str());
    waitKey();
}
