...
private:
  ...
  double model_param_, wheel_diameter_;   //model_param :the width of the car
...
void ChassisDriver::parse_msg(){ //解析
...
void ChassisDriver::run(){
  ...
  private_node.param<double>("reduction_ratio", reduction_ratio_, 2.5);// ???  use to what?
